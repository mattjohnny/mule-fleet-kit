 ...
 */
function houseMessage(status: number): string {
  if (status === 413) return "That upload is too large.";
  if (status < 500) return "That request couldn't be read.";
 ...
 */
export function installTerminalErrorHandler(app: Express): void {
